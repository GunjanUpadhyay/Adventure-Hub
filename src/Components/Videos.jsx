    ...
    <Stack direction={['column', 'row']} h={'100vh'}>
      <VStack w={'full'}>
        ...
        <VStack alignItems={'flex-start'} p={'8'} w={'full'} overflowY={'auto'}>
          ...
          <Text>
          Adventure: Where uncertainty becomes a captivating journey, and each step taken is a brushstroke painting the vivid landscape of the unknown
          </Text>
        </VStack>
      </VStack>
      <VStack
